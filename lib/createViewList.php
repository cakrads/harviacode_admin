...
$string .= "\n\t\t\t<td style=\"text-align:center\">"
        . "\n\t\t\t\t<?php "
        . "\n\t\t\t\techo anchor(site_url('".$controller."/read/'.$".$controller."->".$primary."),'<span class='fa fa-eye'></span>'); "
        . "\n\t\t\t\techo ' | '; "
        . "\n\t\t\t\techo anchor(site_url('".$controller."/update/'.$".$controller."->".$primary."),'<span class='fa fa-edit'></span>'); "
        . "\n\t\t\t\techo ' | '; "
        . "\n\t\t\t\techo anchor(site_url('".$controller."/delete/'.$".$controller."->".$primary."),'<span class='fa fa-trash'></span>','onclick=\"javasciprt: return confirm(\\'Are You Sure ?\\')\"'); "
        . "\n\t\t\t\t?>"
        . "\n\t\t\t</td>";
